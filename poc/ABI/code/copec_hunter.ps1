...
# Author: Script generated for evidence collection
# Date: $(Get-Date)
...
Write-Host "Complete log: $logDirectory\copec_investigation.log" -ForegroundColor White
Write-Host "Evidence: JSON files in $logDirectory directory" -ForegroundColor White
